...
lapop2018$formal_estado <- relevel(lapop2018$formal_estado, ref = "No ocupados")
lapop2018$categoria_ocup_f <- relevel(lapop2018$categoria_ocup_f, ref = "Inactivo")

democracia_fijo <- plm(democracia7 ~ categoria_ocup_f + formal_estado + estatus_ocup_f +
                         ideologia_imp + urbano + sexo + q2 + ed, 
                       data=lapop2018, index=c("country_f"), model="within")

desigualdad_fijo <- plm(reduc_desigualdad ~ categoria_ocup_f + formal_estado +
                          estatus_ocup_f + ideologia_imp + urbano + sexo + q2 + ed, 
                       data=lapop2018, index=c("country_f"), model="within")

desempleados_fijo <- plm(desempleados ~ categoria_ocup_f + formal_estado +
                          estatus_ocup_f + ideologia_imp + urbano + sexo + q2 + ed, 
                       data=lapop2018, index=c("country_f"), model="within")

ayuda_pobres_fijo <- plm(ayuda_pobres ~ categoria_ocup_f + formal_estado +
                          estatus_ocup_f + ideologia_imp + urbano + sexo + q2 + ed, 
                       data=lapop2018, index=c("country_f"), model="within")

impuestos_ricos_fijo <- plm(impuestos_ricos ~ categoria_ocup_f + formal_estado +
                          estatus_ocup_f + ideologia_imp + urbano + sexo + q2 + ed, 
                       data=lapop2018, index=c("country_f"), model="within")
