...
El pseudo r2 para el segundo nivel (países años) en el modelo con efectos fijos + interacción es de **`r R2_grup_m2`**, el los modelos de pendiente aleatoria es de **`r R2_grup_m3`**.
